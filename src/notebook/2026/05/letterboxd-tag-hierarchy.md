---
title: 'Letterboxd tag hierarchy'
pubDate: 2026-05-25
description: 'How I organise my film diary'
author: 'Thamara Kandabada'
imageUrl: 'images/Screenshot-2026-05-25-at-21.54.32-scaled.png'
imageAlt: ''
imageCaption: ''
...
Note how I include the year in the tag. This is useful because by doing this, I forgo the need to run the data through a secondary filter to figure out _when_ a film was seen at a particular location.
...
I use other tags to add more layers of detail, such as film festivals and special screenings, to entries that require it. These tags are helpful for producing lists such as [My LFF 2025, Ranked](https://letterboxd.com/thamarak/list/my-lff-2025-ranked/) (for which the corresponding tag was `lff 2025`).
...
I also keep track of physical media extras. On my [tags page](https://letterboxd.com/thamarak/tags/), you can see tags such as `4k bluray extras 2026` and `bluray extras 2025` which facilitate this.
